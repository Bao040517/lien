...
public class CategoryController {
    ...
    public ApiResponse<List<Category>> getAllCategories() {
        return ApiResponse.success(categoryService.getAllCategories(), "Lấy danh sách danh mục thành công");
    }
    ...
    public ApiResponse<Category> createCategoryWithImage(
        ...
        try {
            ...
            return ApiResponse.success(categoryService.createCategory(category), "Tạo danh mục kèm ảnh thành công");
        } catch (Exception e) {
