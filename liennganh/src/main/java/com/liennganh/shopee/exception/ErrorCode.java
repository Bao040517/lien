...
/**
 * Enum định nghĩa các mã lỗi (ErrorCode) trong hệ thống
 */
@Getter
public enum ErrorCode {
    ...
    VOUCHER_OUT_OF_USAGE(8004, "Voucher đã hết lượt sử dụng (của bạn hoặc toàn hệ thống)", HttpStatus.BAD_REQUEST),
    ...
    FLASH_SALE_CONFLICT(11002, "Khung giờ này đã có Flash Sale khác", HttpStatus.BAD_REQUEST),
    FLASH_SALE_ENDED(11003, "Flash Sale đã kết thúc", HttpStatus.BAD_REQUEST),
    ...
    private final HttpStatus statusCode; // Mã HTTP Status tương ứng
