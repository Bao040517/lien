      ...
      <div className="container mx-auto px-4 text-xs font-bold flex justify-between py-1">
        <div className="flex gap-4">
          ...
          {user?.role === "ADMIN" && (
            <Link
              to="/admin"
              className="hover:text-gray-200 font-semibold border-l pl-4 ml-2 border-white/30"
            >
              Kênh Quản Trị
            </Link>
          )}
        ...
        <div className="flex items-center justify-between gap-10">
          ...
          <div className="flex-1 max-w-2xl">
            <form
              ...
              className="bg-white p-1 rounded-sm flex shadow-sm relative"
            >
              <input
                type="text"
              ...
              <button
                type="submit"
                className="bg-primary-dark px-6 rounded-sm hover:bg-primary-darker transition"
              >
